...
public class ScriptSortBuilderTests extends AbstractSortTestCase<ScriptSortBuilder> {
    ...
    public void testParseJson() throws IOException {
        ...
        ScriptSortBuilder builder = new ScriptSortBuilder(new Script("_na_"), ScriptSortType.STRING).fromXContent(context, null);
    ...
    public void testParseBadFieldNameExceptions() throws IOException {
        ...
        new ScriptSortBuilder(new Script("_na_"), ScriptSortType.STRING).fromXContent(context, null);
    }
