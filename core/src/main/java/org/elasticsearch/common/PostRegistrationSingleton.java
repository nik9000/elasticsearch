 ...
 */
public class PostRegistrationSingleton<T> implements Provider<T> {
    private final Supplier<T> supplier;

    private T instance;
    private boolean registrationComplete = false;

    public PostRegistrationSingleton(Supplier<T> supplier) {
    ...
    public void postRegisration() {
        registrationComplete = true;
    }

    public interface Holder {
        Collection<PostRegistrationSingleton<?>> postRegistrationSingletons();
    }
}
