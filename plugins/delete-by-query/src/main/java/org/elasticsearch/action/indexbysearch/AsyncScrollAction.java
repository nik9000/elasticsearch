...
public abstract class AsyncScrollAction<Request extends ActionRequest<?>, Response> {
    ...
    public AsyncScrollAction(ESLogger logger, TransportSearchAction searchAction, TransportSearchScrollAction scrollAction,
    ...
    protected abstract BulkRequest buildBulk(SearchHit[] docs);
    ...
    void onScrollResponse(final SearchResponse searchResponse) {
        try {
            ...
            BulkRequest request = buildBulk(docs);
            if (logger.isWarnEnabled()) {
