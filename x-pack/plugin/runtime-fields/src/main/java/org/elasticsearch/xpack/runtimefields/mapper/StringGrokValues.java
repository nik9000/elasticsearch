...
public class StringGrokValues extends StringFieldScript { // NOCOMMIT this shouldn't extend script
    // NOCOMMIT we shouldn't really need a factory
    static StringFieldScript.Factory factory(
        String sourceField,
        Grok grok,
        Function<Consumer<String>, GrokCaptureExtracter> buildExtracter
    ) {
        return (fieldName, params, searchLookup) -> {
            ...
            return ctx -> {
                ...
                return new StringGrokValues(fieldName, searchLookup, ctx, grok, buildExtracter, docValues);
            };
        };
    }
