...
public class DoubleGrokValues extends DoubleFieldScript { // NOCOMMIT this shouldn't extend script
    // NOCOMMIT we shouldn't really need a factory
    static DoubleFieldScript.Factory factory(String sourceField, Grok grok, Function<DoubleConsumer, GrokCaptureExtracter> buildExtracter) {
        return (fieldName, params, searchLookup) -> {
            ...
            return ctx -> {
                ...
                return new DoubleGrokValues(fieldName, searchLookup, ctx, grok, buildExtracter, docValues);
            };
        };
    }
    ...
    public DoubleGrokValues(
        String fieldName,
        SearchLookup searchLookup,
        LeafReaderContext ctx,
        Grok grok,
        Function<DoubleConsumer, GrokCaptureExtracter> buildExtracter,
