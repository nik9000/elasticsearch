...
public final class ScriptDoubleFieldData extends IndexNumericFieldData {
    ...
    public static class Builder implements IndexFieldData.Builder {
        ...
        public Builder(String name, DoubleRuntimeValues.LeafFactory leafFactory) {
            this.name = name;
    ...
    private ScriptDoubleFieldData(String fieldName, DoubleRuntimeValues.LeafFactory leafFactory) {
