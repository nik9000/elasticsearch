...
public class DoubleScriptFieldTermsQueryTests extends AbstractDoubleScriptFieldQueryTestCase<DoubleScriptFieldTermsQuery> {
    ...
    public void testMatches() {
        ...
        assertTrue(query.matches(values(new double[] { 0.1 })));
        assertTrue(query.matches(values(new double[] { 0.2 })));
        assertTrue(query.matches(values(new double[] { 7.5 })));
        assertTrue(query.matches(values(new double[] { 0.1, 0 })));
        assertTrue(query.matches(values(new double[] { 0, 0.1 })));
        assertFalse(query.matches(values(new double[] { 0 })));
    }
