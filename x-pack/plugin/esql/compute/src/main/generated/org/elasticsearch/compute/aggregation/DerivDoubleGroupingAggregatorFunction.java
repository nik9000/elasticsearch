...
public final class DerivDoubleGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  DerivDoubleGroupingAggregatorFunction(List<ExpressionEvaluator> inputs,
  ...
  public GroupingAggregatorFunction.AddInput prepareProcessRawInputPage(SeenGroupIds seenGroupIds,
      Page page) {
    DoubleBlock valueBlock = (DoubleBlock) inputs.get(0).eval(page);
  ...
  public void addIntermediateInput(int positionOffset, IntArrayBlock groups, Page page) {
    ...
    try (Block countUncast = inputs.get(0).eval(page); Block sumValUncast = inputs.get(1).eval(page); Block sumTsUncast = inputs.get(2).eval(page); Block sumTsValUncast = inputs.get(3).eval(page); Block sumTsSqUncast = inputs.get(4).eval(page)) {
