...
public final class AllFirstIntByIntAggregatorFunction implements AggregatorFunction {
  ...
  AllFirstIntByIntAggregatorFunction(DriverContext driverContext,
  ...
  private void addRawInputMasked(Page page, BooleanVector mask) {
    try (IntBlock valuesBlock = (IntBlock) inputs.get(0).eval(page); IntBlock timestampsBlock = (IntBlock) inputs.get(1).eval(page)) {
