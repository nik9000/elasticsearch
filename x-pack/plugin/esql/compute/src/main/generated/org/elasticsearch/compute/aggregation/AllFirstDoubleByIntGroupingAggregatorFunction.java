...
public final class AllFirstDoubleByIntGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  AllFirstDoubleByIntGroupingAggregatorFunction(List<ExpressionEvaluator> inputs,
  ...
  public GroupingAggregatorFunction.AddInput prepareProcessRawInputPage(SeenGroupIds seenGroupIds,
      Page page) {
    DoubleBlock valuesBlock = (DoubleBlock) inputs.get(0).eval(page);
    IntBlock timestampsBlock = (IntBlock) inputs.get(1).eval(page);
