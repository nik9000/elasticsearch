...
public final class LastBytesRefByTimestampGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  public LastBytesRefByTimestampGroupingAggregatorFunction(List<Integer> channels,
      LastBytesRefByTimestampAggregator.GroupingState state, DriverContext driverContext) {
    this.channels = channels;
    this.state = state;
    this.driverContext = driverContext;
  }

  public static LastBytesRefByTimestampGroupingAggregatorFunction create(List<Integer> channels,
      DriverContext driverContext) {
    return new LastBytesRefByTimestampGroupingAggregatorFunction(channels, LastBytesRefByTimestampAggregator.initGrouping(driverContext), driverContext);
  }
  ...
  public GroupingAggregatorFunction.PreparedToEvaluate prepareEvaluateFinal(IntVector selected,
    ...
    return new GroupingAggregatorFunction.PreparedToEvaluate() {
      ...
      public void evaluate(Block[] blocks, int offset, IntVector selected,
        ...
        blocks[offset] = LastBytesRefByTimestampAggregator.evaluateFinal(state, selected, ctx);
      }
