...
public final class AllFirstDoubleByIntAggregatorFunction implements AggregatorFunction {
  ...
  AllFirstDoubleByIntAggregatorFunction(DriverContext driverContext,
  ...
  private void addRawInputMasked(Page page, BooleanVector mask) {
    try (DoubleBlock valuesBlock = (DoubleBlock) inputs.get(0).eval(page); IntBlock timestampsBlock = (IntBlock) inputs.get(1).eval(page)) {
