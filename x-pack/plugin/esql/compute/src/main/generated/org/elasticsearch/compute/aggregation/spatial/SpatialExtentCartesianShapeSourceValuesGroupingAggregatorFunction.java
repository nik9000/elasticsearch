...
public final class SpatialExtentCartesianShapeSourceValuesGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  SpatialExtentCartesianShapeSourceValuesGroupingAggregatorFunction(
      List<ExpressionEvaluator> inputs, DriverContext driverContext) {
    this.inputs = inputs;
  ...
  public void evaluateFinal(Block[] blocks, int offset, IntVector selected,
    ...
    blocks[offset] = SpatialExtentCartesianShapeSourceValuesAggregator.evaluateFinal(state, selected, ctx);
  }
