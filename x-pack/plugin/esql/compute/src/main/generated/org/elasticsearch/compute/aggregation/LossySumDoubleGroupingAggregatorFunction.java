...
public final class LossySumDoubleGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  LossySumDoubleGroupingAggregatorFunction(List<ExpressionEvaluator> inputs,
  ...
  public GroupingAggregatorFunction.AddInput prepareProcessRawInputPage(SeenGroupIds seenGroupIds,
      Page page) {
    DoubleBlock vBlock = (DoubleBlock) inputs.get(0).eval(page);
  ...
  public void addIntermediateInput(int positionOffset, IntArrayBlock groups, Page page) {
    ...
    try (Block valueUncast = inputs.get(0).eval(page); Block unusedDeltasUncast = inputs.get(1).eval(page); Block seenUncast = inputs.get(2).eval(page)) {
