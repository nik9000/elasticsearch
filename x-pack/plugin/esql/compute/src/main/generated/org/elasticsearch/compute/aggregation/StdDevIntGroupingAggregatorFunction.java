...
public final class StdDevIntGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  StdDevIntGroupingAggregatorFunction(List<ExpressionEvaluator> inputs, DriverContext driverContext,
      boolean stdDev) {
    this.stdDev = stdDev;
    this.inputs = inputs;
  ...
  public void evaluateFinal(Block[] blocks, int offset, IntVector selected,
    ...
    blocks[offset] = StdDevIntAggregator.evaluateFinal(state, selected, ctx);
  }
