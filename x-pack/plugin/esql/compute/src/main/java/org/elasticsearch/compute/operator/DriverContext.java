...
public class DriverContext {
    ...
    /**
     * Mutable sink shared with all evaluators in this driver. Evaluators append
     * to this sink directly. {@code null} means warnings are ignored.
     */
    @Nullable
    private final WarningsSink warnings;
    ...
    public DriverContext(BigArrays bigArrays, BlockFactory blockFactory, @Nullable LocalCircuitBreaker.SizeSettings localBreakerSettings) {
        this(bigArrays, blockFactory, localBreakerSettings, null, new WarningsSink());
    }
    ...
    public DriverContext(
        ...
        this(bigArrays, blockFactory, localBreakerSettings, description, new WarningsSink());
    }
    ...
    private DriverContext(
        ...
        @Nullable WarningsSink warnings
    ) {
    ...
    public record Snapshot(Set<Releasable> releasables, Set<String> warnings) implements Releasable {
        /**
    ...
    public void finish() {
        ...
        snapshot.compareAndSet(null, new Snapshot(releasableSet, warnings != null ? warnings.takeWarnings() : Set.of()));
    }
    ...
    /**
     * Returns the warnings sink that evaluators should append to, or {@code null}
     * if warnings should be ignored.
     */
    @Nullable
    public WarningsSink warnings() {
        return warnings;
    }
