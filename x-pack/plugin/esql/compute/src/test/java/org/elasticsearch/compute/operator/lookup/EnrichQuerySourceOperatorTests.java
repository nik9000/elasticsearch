...
public class EnrichQuerySourceOperatorTests extends ESTestCase {
    ...
    public void testQueries() throws Exception {
        try (
            ...
            // 4 -> [a3] -> [3]
            // 5 -> [] -> []
            List<String> warningsList = new java.util.ArrayList<>();
            try (
    ...
    public void testQueries_OnlySingleValues() throws Exception {
        try (
            ...
            Warnings w = Warnings.createWarnings(warningsList, new TestWarningsSource("test"));
            QueryList queryList = QueryList.rawTermQueryList(directoryData.field, AliasFilter.EMPTY, 0, ElementType.BYTES_REF)
    ...
    private static Warnings warnings(List<String> warningsList) {
        return Warnings.createWarnings(warningsList, new TestWarningsSource("test"));
    }
