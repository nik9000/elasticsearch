...
public class BlockSerializationTests extends SerializationTestCase {
    ...
    public void testSimulateAggs() {
        ...
        var function = new SumLongAggregatorFunctionSupplier().aggregator(driverCtx, List.of(new LoadFromPageEvaluator(0)));
        ...
        try {
            ...
            try {
                ...
                var inputEvaluators = IntStream.range(0, SumLongAggregatorFunction.intermediateStateDesc().size())
                    ...
                    .toList();
                try (var finalAggregator = new SumLongAggregatorFunctionSupplier().aggregator(driverCtx, inputEvaluators)) {
