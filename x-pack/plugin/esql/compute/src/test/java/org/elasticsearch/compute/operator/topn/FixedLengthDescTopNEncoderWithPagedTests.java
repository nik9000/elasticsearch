...
public class FixedLengthDescTopNEncoderWithPagedTests extends AbstractFixedTopNEncoderWithPagedTests {
    public FixedLengthDescTopNEncoderWithPagedTests(TestCase<?> testCase) {
        super(testCase);
    }
