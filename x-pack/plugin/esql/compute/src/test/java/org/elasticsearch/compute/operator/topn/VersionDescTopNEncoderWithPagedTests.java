...
public class VersionDescTopNEncoderWithPagedTests extends AbstractVersionTopNEncoderWithPagedTests {
    public VersionDescTopNEncoderWithPagedTests(TestCase<?> testCase) {
        super(testCase);
    }
