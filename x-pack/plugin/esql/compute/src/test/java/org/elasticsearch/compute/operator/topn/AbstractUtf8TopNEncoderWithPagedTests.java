...
public abstract class AbstractUtf8TopNEncoderWithPagedTests extends AbstractSortableTopNEncoderWithPagedTests {
    @ParametersFactory
    ...
    protected AbstractUtf8TopNEncoderWithPagedTests(TestCase<?> testCase) {
        super(testCase);
    }
