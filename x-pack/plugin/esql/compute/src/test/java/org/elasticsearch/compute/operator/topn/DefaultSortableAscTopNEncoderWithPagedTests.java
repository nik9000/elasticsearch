...
public class DefaultSortableAscTopNEncoderWithPagedTests extends AbstractDefaultSortableTopNEncoderWithPagedTests {
    public DefaultSortableAscTopNEncoderWithPagedTests(TestCase<?> testCase) {
        super(testCase);
    }
