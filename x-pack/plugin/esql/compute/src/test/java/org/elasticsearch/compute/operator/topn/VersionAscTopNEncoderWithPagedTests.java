...
public class VersionAscTopNEncoderWithPagedTests extends AbstractVersionTopNEncoderWithPagedTests {
    public VersionAscTopNEncoderWithPagedTests(TestCase<?> testCase) {
        super(testCase);
    }
