...
public interface SearchStats {
    ...
    /**
     * When reading from a {@code COLLECT}ed result we don't have any
     * statistics but all fields that are stored exist.
     */
    record CollectedSearchStats() implements SearchStats {
        @Override
        public boolean exists(String field) {
            return true;
        }
