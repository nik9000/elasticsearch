 ...
 */
public final class ViewMetadata extends AbstractNamedDiffable<Metadata.Custom> implements Metadata.Custom {
    public static final String TYPE = "esql_view";

    static final ParseField VIEWS = new ParseField("views");

    public static final ViewMetadata EMPTY = new ViewMetadata(Map.of());
    ...
    public TransportVersion getMinimalSupportedVersion() {
        // NOCOMMIT set this to something sane
