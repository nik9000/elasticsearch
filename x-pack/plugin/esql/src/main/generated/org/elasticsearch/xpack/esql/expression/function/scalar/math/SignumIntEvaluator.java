 ...
 */
public final class SignumIntEvaluator implements ExpressionEvaluator {
  ...
  public SignumIntEvaluator(Source source, ExpressionEvaluator val, DriverContext driverContext) {
    this.source = source;
    this.val = val;
