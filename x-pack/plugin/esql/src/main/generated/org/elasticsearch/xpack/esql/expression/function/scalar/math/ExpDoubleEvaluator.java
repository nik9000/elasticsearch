 ...
 */
public final class ExpDoubleEvaluator implements ExpressionEvaluator {
  ...
  public ExpDoubleEvaluator(Source source, ExpressionEvaluator val, DriverContext driverContext) {
    this.source = source;
    this.val = val;
