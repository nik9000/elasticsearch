 ...
 */
public final class Log10IntEvaluator implements ExpressionEvaluator {
  ...
  public Log10IntEvaluator(Source source, ExpressionEvaluator val, DriverContext driverContext) {
    this.source = source;
    this.val = val;
