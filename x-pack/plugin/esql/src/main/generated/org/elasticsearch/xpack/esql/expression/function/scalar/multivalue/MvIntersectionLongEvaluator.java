 ...
 */
public final class MvIntersectionLongEvaluator implements ExpressionEvaluator {
  ...
  public MvIntersectionLongEvaluator(Source source, ExpressionEvaluator field1,
  ...
  public String toString() {
    return "MvIntersectionLongEvaluator[" + "field1=" + field1 + ", field2=" + field2 + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public MvIntersectionLongEvaluator get(DriverContext context) {
      return new MvIntersectionLongEvaluator(source, field1.get(context), field2.get(context), context);
    }
