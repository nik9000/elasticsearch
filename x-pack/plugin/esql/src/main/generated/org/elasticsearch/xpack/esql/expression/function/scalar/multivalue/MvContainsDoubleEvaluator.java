 ...
 */
public final class MvContainsDoubleEvaluator implements ExpressionEvaluator {
  ...
  public MvContainsDoubleEvaluator(Source source, ExpressionEvaluator superset,
  ...
  public Block eval(Page page) {
    try (DoubleBlock supersetBlock = (DoubleBlock) superset.eval(page)) {
      try (DoubleBlock subsetBlock = (DoubleBlock) subset.eval(page)) {
  ...
  public BooleanBlock eval(int positionCount, DoubleBlock supersetBlock, DoubleBlock subsetBlock) {
  ...
  public String toString() {
    return "MvContainsDoubleEvaluator[" + "superset=" + superset + ", subset=" + subset + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public MvContainsDoubleEvaluator get(DriverContext context) {
      return new MvContainsDoubleEvaluator(source, superset.get(context), subset.get(context), context);
    }
