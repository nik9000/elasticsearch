...
public class RegisteredDomainFunctionBridgeTests extends AbstractCompoundOutputEvaluatorTests {
    ...
    public void testMultiValue() {
        ...
        evaluateAndCompare(input, requestedFields, expected, Warnings.createWarnings(warningsSink, WARNING_SOURCE));
        assertThat(
    ...
    public void testInvalidInput() {
        ...
        assertThat(
            ...
            containsInAnyOrder(
                "Line 1:2: evaluation of [invalid_input] failed, treating result as null. Only first 20 failures recorded.",
                "Line 1:2: java.lang.IllegalArgumentException: Invalid domain [$]"
            )
        );
    }
