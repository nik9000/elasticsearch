...
public class ToRadiansTests extends AbstractScalarFunctionTestCase {
    ...
    public static Iterable<Object[]> parameters() {
        ...
        unary().evaluatorToString("ToRadiansEvaluator[deg=%0]")
            .expectedFromDouble(Math::toRadians)
            .convertingToDouble(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, true, suppliers);
