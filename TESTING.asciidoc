...
$ tar -xzf elasticsearch-2.0.0-beta1.tar.gz
$ popd
---------------------------------------------------------------------------

To run backwards compatibilty tests:

---------------------------------------------------------------------------
$ cd core
$ mvn verify -Dtests.filter="@backwards" -Dtests.bwc.version=2.0.0-beta1 -Dtests.bwc.path="$(pwd)/backwards" -Dtests.security.manager=false -Dskip.unit.tests -Pdev -Dtests.jvms=1
---------------------------------------------------------------------------
